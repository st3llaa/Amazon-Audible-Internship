...
public class HelloWorldIntentHandler implements RequestHandler {
    ...
    public Optional<Response> handle(HandlerInput input) {
        log(input, "Starting hello world request");
        logSlots(input);
        ...
        if(slots.containsKey("CityNameSlot") && null != slots.get("CityNameSlot").getValue()) {
            speechText = String.format(speechTextWithCity, slots.get("CityNameSlot").getValue());
        } else {
            speechText = speechTextNoCityName;
        }
